...
@section('content')
                    ...
                    <div class="modal-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="name" name="name" class="form-control" placeholder="Masukkan Nama Satuan">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modalDelete">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.unit.destroy', ['id' => '#']) }}" method="post" id="formDelete">
                	{{ method_field('DELETE') }}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-body">
                        <p id="del-success">Anda yakin ingin menghapus Satuan ?</p>
                    </div>
                    <div class="modal-footer">
	...
	<script>
        jQuery(document).ready(function($){
            ...
            $('#btnAdd').click(function () {
                $('#formAdd')[0].reset();
                $('#formAdd .modal-title').text("Tambah Satuan");
            ...
            $('#data_table').on('click', '.edit-btn', function(e){
                $('#formAdd div.form-group').removeClass('has-error');
                $('#formAdd .help-block').empty();
                $('#formAdd .modal-title').text("Ubah Satuan");
                $('#formAdd')[0].reset();
                ...
                url = '{{ route("admin.unit.index") }}' + '/' + aData.id;
