	...
	<script>
        jQuery(document).ready(function($){
                ...
                "columns": [
                    ...
                    },
                    {
                        render : function(data, type, row){
                            return	'<a href="#" class="edit-btn btn btn-xs btn-warning"><i class="fa fa-pencil"> Ubah</i></a>';
                        },
                        "width": "10%",
                        "orderable": false,
                    }
            ...
            $('#data_table').on('click', '.edit-btn', function(e){
                ...
                url = '{{ route("seller.bank.index") }}' + '/' + aData.id;
