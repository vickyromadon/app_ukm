			...
			<div class="box box-default">
				...
				<div class="box-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered">
						...
						<li class="list-group-item">
							<b>Nomor Handphone</b>
							<p class="pull-right">{{ $data->seller->phone }}</p>
						</li>
						<li class="list-group-item">
							<b>Alamat</b>
							<p class="pull-right">{{ $data->seller->location->address }}</p>
						</li>
						<li class="list-group-item">
							<b>Kecamatan</b>
							<p class="pull-right">{{ $data->seller->location->sub_district }}</p>
						</li>
						<li class="list-group-item">
							<b>Kabupaten</b>
							<p class="pull-right">{{ $data->seller->location->district }}</p>
						</li>
						<li class="list-group-item">
							<b>Provinsi</b>
							<p class="pull-right">{{ $data->seller->location->province }}</p>
						</li>
					</ul>
                </div>
            </div>
					...
					<div class="active tab-pane" id="settings">
						<form class="form-horizontal" method="POST" id="formSetting">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="phone" name="phone" placeholder="Masukkan Nomor Handphone" value="{{ $data->seller->phone }}">
					...
					<div class="tab-pane" id="location">
						<form class="form-horizontal" method="POST" id="formLocation">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea name="address" id="address" class="form-control" placeholder="Masukkan Alamat">{{ $data->seller->location->address }}</textarea>
									<span class="help-block"></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
                                    <input type="text" name="sub_district" id="sub_district" class="form-control" placeholder="Masukkan Kecamatan" value="{{ $data->seller->location->sub_district }}">
									<span class="help-block"></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
                                    <input type="text" name="district" id="district" class="form-control" placeholder="Masukkan Kabupaten" value="{{ $data->seller->location->district }}">
									<span class="help-block"></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
                                    <input type="text" name="province" id="province" class="form-control" placeholder="Masukkan Provinsi" value="{{ $data->seller->location->province }}">
									<span class="help-block"></span>
								</div>
							</div>
							<div class="form-group">
        ...
        jQuery(document).ready(function($){
            $('#formSetting').submit(function (event) {
    	        ...
    	        $('#formSetting .help-block').empty();
    		 	...
    		 	$.ajax({
                    url: "{{ route('seller.profile.change-setting', ['id' => $data->id]) }}",
                    method: 'POST',
                    data: _data,
                    cache: false,
            ...
            $('#formPassword').submit(function (event) {
    	        ...
    	        $('#formPassword .help-block').empty();
    		 	...
    		 	$.ajax({
                    url: "{{ route('seller.profile.change-password', ['id' => $data->id]) }}",
                    method: 'POST',
                    data: _data,
                    cache: false,
            ...
            $('#formLocation').submit(function (event) {
    	        ...
    	        $('#formLocation .help-block').empty();
    		 	...
    		 	$.ajax({
                    url: "{{ route('seller.profile.change-location', ['id' => $data->id]) }}",
                    method: 'POST',
                    data: _data,
                    cache: false,
                    ...
                    success: function (response) {
                    	...
                    	if (response.status === 422) {
                            ...
                            $.each(data, function(key, value){
                                if( error[data[key].name] != undefined ){
                                    var elem = $("#formLocation input[name='" + data[key].name + "']").length ? $("#formLocation input[name='" + data[key].name + "']") : $("#formLocation select[name='" + data[key].name + "']");
                                    elem.parent().find('.help-block').text(error[data[key].name]);
                                    elem.parent().find('.help-block').show();
                                    elem.parent().parent().addClass('has-error');
                                }
